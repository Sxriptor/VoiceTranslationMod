...
declare const bidirectionalInputSelect: HTMLSelectElement | null;
...
declare let bidirectionalInputDeviceId: string | null;
declare let incomingVoiceId: string | null;
declare let bidiAudioStream: MediaStream | null;
declare let bidiVadThreshold: number;
declare let bidiCalibrating: boolean;
declare let bidiCalibSamples: number;
declare let bidiCalibAccum: number;
declare let bidiLastProbeAttemptTs: number;
declare let bidiBaseline: number;
declare let bidiConsecutiveActiveFrames: number;
declare let bidiStartTs: number;
...
declare function loadBidirectionalInputDevices(): Promise<void>;
declare function loadIncomingVoices(): Promise<void>;
declare function onBidirectionalOutputChange(): Promise<void>;
declare function onBidirectionalInputChange(): Promise<void>;
